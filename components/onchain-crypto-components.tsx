...
// Chart components
import { CryptoChart } from '@/components/crypto-charts';
    ...
    <div className="mb-4 space-y-3">
      ...
      <div className="space-y-2">
        {sortedData.map((token: any, index: number) => {
          ...
          return (
            <Card key={token.address || index} className="p-4 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors">
