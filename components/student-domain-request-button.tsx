...
`
    : ''
}I am a current student at this university and would love to access the student discount for Hyper Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:zaid@hyper.vercel.app?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
