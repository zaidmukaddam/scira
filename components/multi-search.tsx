...
const SearchLoadingState = ({ queries, annotations }: { queries: string[]; annotations: QueryCompletion[] }) => {
  ...
  return (
    <div className="w-[280px] shrink-0 bg-background rounded-lg border border-border/50 transition-all">
      <div className="p-3">
        ...
        <p className="text-xs text-muted-foreground line-clamp-3 mb-2">{result.content}</p>
