...
const models = [
    ...
    { value: "scira-opus", label: "Claude 4 Opus", icon: AnthropicIcon, iconClass: "text-current", description: "Anthropic's most advanced reasoning model", color: "violet", vision: true, reasoning: true, experimental: false, category: "Pro", pdf: true, pro: true },
