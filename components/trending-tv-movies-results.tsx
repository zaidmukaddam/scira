...
const TrendingResults = ({ result, type }: TrendingResultsProps) => {
	...
	const displayedResults = useMemo(() => {
		return showAll
			? result.results
			: result.results.slice(0, isMobile ? 4 : 10);
	...
	return (
		<T id="components.trending_tv_movies_results.7">
			<div className="w-full my-4 sm:my-6">
				<header className="flex items-center justify-between mb-4 sm:mb-6 px-4 sm:px-0">
					<div className="flex items-center gap-2 sm:gap-3">
						...
						<div>
							<h2 className="text-lg sm:text-xl font-semibold">
								...
								<Var>
									{type === "movie" ? (
										<T id="components.trending_tv_movies_results.0">
											{"Movies"}
										</T>
									) : (
										<T id="components.trending_tv_movies_results.1">
											{"Shows"}
										</T>
									)}
								</Var>
					...
					>
						<Var>
							{showAll ? (
								<T id="components.trending_tv_movies_results.2">
									{"Show Less"}
								</T>
							) : (
								<T id="components.trending_tv_movies_results.3">{"View All"}</T>
							)}
						</Var>
				...
				<Var>
					{isMobile && showAll && (
						<T id="components.trending_tv_movies_results.6">
									...
									<div className="flex flex-col h-[90vh]">
										<div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-800">
											<h3 className="text-lg font-semibold">
												...
												<Var>
													{type === "movie" ? (
														<T id="components.trending_tv_movies_results.4">
															{"Movies"}
														</T>
													) : (
														<T id="components.trending_tv_movies_results.5">
															{"Shows"}
														</T>
													)}
												</Var>
