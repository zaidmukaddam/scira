    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to Atlas AI. These Terms of Service govern your use of our website and services. By using Atlas AI,
          ...
          <p>
            By accessing or using Atlas AI, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of Atlas AI after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            Atlas AI is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use Atlas AI to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, Atlas AI:</p>
          <ul>
          ...
          <p>
            ...
            Atlas AI should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of Atlas AI, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of Atlas AI or its licensors and are protected by
          ...
          <p>Atlas AI relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using Atlas AI, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <p>
            Atlas AI offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>Atlas Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of Atlas AI is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, Atlas AI shall not be liable for any indirect, incidental, special,
          ...
          <p>
            Atlas AI is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to Atlas AI, with or without notice, for conduct
          ...
          <p>
            ...
            Atlas AI operates, without regard to its conflict of law provisions.
          </p>
          ...
          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using Atlas AI, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
